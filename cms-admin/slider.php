...
if (isset($_POST['create'])) {
    extract($_POST);
    if (!empty($slider_title) && !empty($slider_sub_title) && !empty($_FILES['photo']['name'])) {
        ...
        $insert = array('slider_title' => $slider_title, 'slider_sub_title' => $slider_sub_title, 'photo' => $photo, 'date' => date('Y-m-d'), 'status' => 1);
    ...
    extract($_POST);
    if (!empty($slider_title) && !empty($slider_sub_title)) {
        ...
        if (!empty($_FILES['photo']['name'])) {
            ...
            $photo = $ex_photo;
        }$upd2 = array('slider_title' => $slider_title, 'slider_sub_title' => $slider_sub_title, 'photo' => $photo, 'date' => date('Y-m-d'), 'status' => 1);
                    ...
                    if (isset($_GET['edit'])) {
                        ...
                        <div class="widget-body"><form enctype='multipart/form-data' class="form-horizontal" method="post" action="" role="form">
                                <input type="hidden" name="id" value="<?php echo $_GET['edit']; ?>"><div class='form-group'>
                                    ...
                                    <div class='col-sm-9'>
                                        <input type='text' id='form-field-1' name='slider_title' value='<?php echo $obj->SelectAllByVal($table, "id", $_GET['edit'], "slider_title"); ?>' placeholder='Slider Title' class='form-control' />
                                    </div>
                                </div><div class='form-group'>
                                    <label  for="inputEmail3" class="col-sm-2 control-label"> Slider Sub Title </label>

                                    <div class='col-sm-9'>
                                        <input type='text' id='form-field-1' name='slider_sub_title' value='<?php echo $obj->SelectAllByVal($table, "id", $_GET['edit'], "slider_sub_title"); ?>' placeholder='Slider Sub Title' class='form-control' />
                                    </div>
                                </div><div class='form-group'>
...
<?php } else { ?>
                        ...
                        <div class="widget-body"><form enctype='multipart/form-data' class="form-horizontal" method="post" action="" role="form"><div class='form-group'>
                                    ...
                                    <div class='col-sm-9'>
                                        <input type='text' id='form-field-1' name='slider_title' placeholder='Slider Title' class='form-control' />
                                    </div>
                                </div><div class='form-group'>
                                    <label  for="inputEmail3" class="col-sm-2 control-label"> Slider Sub Title </label>

                                    <div class='col-sm-9'>
                                        <input type='text' id='form-field-1' name='slider_sub_title' placeholder='Slider Sub Title' class='form-control' />
                                    </div>
                                </div><div class='form-group'>
                                    <label  for="inputEmail3" class="col-sm-2 control-label"> Photo </label>
