<?php 
		...
		if(isset($_POST['create'])){
			...
			$photo=$imgclassget->upload_fiximage("upload","photo","photo_upload_".$table_name."_".time());  $insert=array('photo'=>$photo,'date'=>date('Y-m-d'),'status'=>1);
		...
		{
			extract($_POST);$updatearray=array("id"=>$id);if(!empty($_FILES['photo']['name']))
					{
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    ...
    <body class="">
        ...
        <div id="content">
        	<h1 class="content-heading bg-white border-bottom">Gallery</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New Gallery</a></li>
                    <li><a href="gallery_data.php">Gallery List</a></li>
                </ul>
            </div>
                ...
                <!-- Widget -->
                        ...
                        <div class="widget widget-inverse" >
                            ...
                            <div class="widget-head">
                                <h4 class="heading">Update/Change - Gallery</h4>
                            </div>
                            <!-- // Widget heading END -->
                            ...
                            <!-- Widget heading -->
                            <div class="widget-head">
                                <h4 class="heading">Create New Gallery</h4>
                            </div>
                            <!-- // Widget heading END -->
