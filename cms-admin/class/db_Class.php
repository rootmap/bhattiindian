...
class db_class {
    ...
    public function open() {
        $con=mysqli_connect("localhost", "web3matr_Cafe123", "Cafe123_987%", "web3matr_Cafebalti_2017");
        return $con;
    }

    public function pdocon() {
        $db=new PDO("mysql:host=localhost;dbname=web3matr_Cafebalti_2017;", "web3matr_Cafe123", "Cafe123_987%");
    ...
    function baseUrl($suffix='') {
        ...
        $web_root=$protocol . $_SERVER['HTTP_HOST'] . "/" . "cms-admin/";
        $suffix=ltrim($suffix, '/');
