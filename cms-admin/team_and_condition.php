<?php 
		...
		$table="team_and_condition"; ?>
		<?php 
		if(isset($_POST['create'])){
			extract($_POST);
			if(!empty($name) && !empty($details))
			{  $insert=array('name'=>$name,'details'=>$details,'date'=>date('Y-m-d'),'status'=>1);
		...
		{
			extract($_POST);if(!empty($name) && !empty($details))
			{$updatearray=array("id"=>$id);$upd2=array('name'=>$name,'details'=>$details,'date'=>date('Y-m-d'),'status'=>1);
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    ...
    <body class="">
        ...
        <div id="content">
        	<h1 class="content-heading bg-white border-bottom">Team and Condition</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New Team and Condition</a></li>
                    <li><a href="team_and_condition_data.php">Team and Condition List</a></li>
                </ul>
            </div>
                ...
                <!-- Widget -->
                        ...
                        <div class="widget widget-inverse" >
                            ...
                            <div class="widget-head">
                                <h4 class="heading">Update/Change - Team and Condition</h4>
                            </div>
                            <!-- // Widget heading END -->
                            ...
                            <!-- Widget heading -->
                            <div class="widget-head">
                                <h4 class="heading">Create New Team and Condition</h4>
                            </div>
                            <!-- // Widget heading END -->
