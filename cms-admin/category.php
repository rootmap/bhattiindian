<?php 
        ...
        $pr=$sqlpr[0]->pr+1;
        $insert=array('name'=>$name,'is_active'=>$is_active,'priority'=>$pr,'date'=>date('Y-m-d'),'status'=>1);
		...
		elseif(isset($_POST['update'])) 
		{
			...
			extract($_POST);
			if(!empty($name))
			{$updatearray=array("id"=>$id);$upd2=array('name'=>$name,'is_active'=>$is_active,'date'=>date('Y-m-d'),'status'=>1);
		...
		{
			$delarray=array("id"=>$_GET['del']);if($obj->delete($table,$delarray)==1)
			{ 
    ...
    <body class="">
        ...
        <div id="content">
            ...
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New Category</a></li>
                    <li><a href="category_data.php">Category List</a></li>
                </ul>
            </div>
                ...
                <!-- Widget -->
                        ...
                        <div class="widget widget-inverse" >
                            ...
                            <div class="widget-head">
                                <h4 class="heading">Update/Change - Category</h4>
                            </div>
                            <!-- // Widget heading END -->
                            ...
                            <!-- Widget heading -->
                            <div class="widget-head">
                                <h4 class="heading">Create New Category</h4>
                            </div>
                            <!-- // Widget heading END -->
