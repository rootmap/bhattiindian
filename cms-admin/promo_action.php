...
if (isset($_POST['create'])) {
    extract($_POST);
    if (!empty($title) && !empty($_FILES['photo']['name']) && !empty($details)) {
        ...
        $insert = array('title' => $title, 'photo' => $photo, 'details' => $details, 'date' => date('Y-m-d'), 'status' => 1);
    ...
    if (!empty($title) && !empty($details)) {
        ...
        if (!empty($_FILES['photo']['name'])) {
            ...
            $photo = $ex_photo;
        }$upd2 = array('title' => $title, 'photo' => $photo, 'details' => $details, 'date' => date('Y-m-d'), 'status' => 1);
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    ...
    <body class="">
        ...
        <div id="content">
            <h1 class="content-heading bg-white border-bottom">Promo Action</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New Promo Action</a></li>
                    <li><a href="promo_action_data.php">Promo Action List</a></li>
                </ul>
            </div>
                ...
                <div class="widget widget-inverse" >
                    ...
                    if (isset($_GET['edit'])) {
                        ...
                        <div class="widget-head">
                            <h4 class="heading">Update/Change - Promo Action</h4>
                        </div>
                        <!-- // Widget heading END -->
...
<?php } else { ?>
                        <!-- Widget heading -->
                        <div class="widget-head">
                            <h4 class="heading">Create New Promo Action</h4>
                        </div>
                        <!-- // Widget heading END -->
