<?php 
		...
		{
			extract($_POST);if(!empty($name))
			{$updatearray=array("id"=>$id);$upd2=array('name'=>$name,'date'=>date('Y-m-d'),'status'=>1);
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    ...
    <body class="">
        ...
        <div id="content">
        	<h1 class="content-heading bg-white border-bottom">Chef Recommended</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New Chef Recommended</a></li>
                    <li><a href="chef_recommended_data.php">Chef Recommended List</a></li>
                </ul>
            </div>
                ...
                <!-- Widget -->
                        ...
                        <div class="widget widget-inverse" >
                            ...
                            <div class="widget-head">
                                <h4 class="heading">Update/Change - Chef Recommended</h4>
                            </div>
                            <!-- // Widget heading END -->
                            ...
                            <!-- Widget heading -->
                            <div class="widget-head">
                                <h4 class="heading">Create New Chef Recommended</h4>
                            </div>
                            <!-- // Widget heading END -->
