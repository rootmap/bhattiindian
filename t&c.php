...
<html lang="en-US">
    ...
    <head>
        ...
        <title>Team and Conditions - <?= $site_basic_info[0]->site_name; ?></title>
...
<meta name="Keywords" content="<?= $seo[0]->meta_keywords; ?>">
        ...
        <script type="text/javascript" src="javascript/web-elements.js"></script> 
        <style type="text/css">
            .heads-up {
            ...
            <div id="container">
                <div id="content" class="center">
                    ...
                    <dl class="tabs_type_1">
                        <!-- Tab 1 -->
                        <?php
                        $teamandc = $obj->FlyQuery("SELECT * FROM `team_and_condition` ORDER BY id DESC  ");
                        if (!empty($teamandc)) {
                            $i = 1;
                            foreach ($teamandc as $tc):
                                if ($i == 1) {
                                    ?>
                                    <dt class="current"><?php echo $tc->name; ?></dt>
                                    <dd class="current">
                                        <!--<h2>Pellentesque Nibh Mattis</h2>-->
                                        <div class="one_third">
                                            <p><?php echo html_entity_decode($tc->details); ?></p>
                                        </div>
                                    </dd>
                                    <!-- END tab 1 -->
                                    <?php
