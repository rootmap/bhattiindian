...
<body class="page-template-default page page-id-12 woocommerce-account woocommerce-page woocommerce-lost-password">
            ...
            <div id="content" class="center">
                <div class="post-12 page type-page status-publish hentry">
                    <div class="woocommerce">
                        <div class="woocommerce-message"><a href="cart\index.htm" class="button wc-forward">View Cart</a> &ldquo;Cherry Pie&rdquo; has been added to your cart.</div>
                        <div class="woocommerce-message"><a href="cart\index.htm" class="button wc-forward">View Cart</a> &ldquo;Cherry Pie&rdquo; has been added to your cart.</div>
                        ...
                        <form method="post" class="woocommerce-ResetPassword lost_reset_password">
                            ...
                            <input type="hidden" id="_wpnonce" name="_wpnonce" value="8cab300a92">
    ...
    <script type='text/javascript'>
        ...
        var wc_add_to_cart_params = {
            ...
            "wc_ajax_url": "\/my-account\/lost-password\/?wc-ajax=%%endpoint%%",
    ...
    <script type='text/javascript' src='wp-content\plugins\woocommerce\assets\js\frontend\lost-password.min.js?ver=2.6.14'></script>
